    ...
    <div className="app">
      ...
      <section className="hero" id="top">
        <div className="hero-content">
          ...
          <p className="hero-subtitle">
            ...
            solution configuration, debugging, and reverse engineering.
            Experienced in peer code reviews, technical documentation, and
            communicating technical concepts to non-technical stakeholders.
            Hands-on with <strong>Azure</strong>, <strong>Docker</strong>,{" "}
            <strong>Angular 16+</strong>, <strong>NgRx</strong>,{" "}
            <strong>EF Core</strong>, and <strong>CI/CD</strong>.
          </p>
      ...
      <section id="about">
        <div className="section-title">
          ...
          <p>
            Results-driven engineering with sharp focus on reliable enterprise
            delivery
          </p>
        </div>
        <div className="about-card">
          <div className="about-card-inner">
            ...
            <p>
              ...
              Hands-on with <strong>Azure</strong>, <strong>Docker</strong>,{" "}
              <strong>Angular 16+</strong>, <strong>NgRx</strong>,{" "}
              <strong>EF Core</strong>, and <strong>CI/CD</strong> pipelines.
            </p>
          </div>
          <div className="stats">
            {[
      ...
      <section id="skills">
        <div className="section-title">
          ...
          <p>
            Languages, Frameworks, Cloud, Databases, Architecture, Testing,
      ...
      {resumeModalOpen && (
        ...
        >
          <div
            className="project-modal resume-modal"
          ...
          >
            ...
            <div className="modal-header">
              ...
              <p className="modal-desc">
                Pune, IN | prafulnimje1999@gmail.com | +919021070022 |
                linkedin.com/in/prafull-nimje | github.com/PrafulNimje
              </p>
            </div>
            ...
            <div className="modal-body resume-preview-body">
              <div className="resume-section-preview">
                ...
                <p>
                  ...
                  in peer code reviews, technical documentation, and
                  communicating technical concepts to non-technical
                  stakeholders. Hands-on with Azure, Docker, Angular 16+, NgRx,
                  EF Core, and CI/CD.
                </p>
              </div>
              ...
              <div className="resume-section-preview">
                <h4>Education</h4>
                <p>
                  <strong>Post Graduate Diploma – Big Data Analytics</strong>{" "}
                  (Mar 2023 – Aug 2023 | 68.75%)
                  <br />
                  Centre for Development of Advanced Computing (CDAC), Noida
                </p>
                <p style={{ marginTop: "0.5rem" }}>
                  <strong>B.E. – Computer Science & Engineering</strong> (Aug
                  2017 – Aug 2021 | 70.77%)
                  <br />
              ...
              <div className="resume-section-preview">
                ...
                <p>
                  ...
                  <br />
                  • Full Stack .NET — Seed Infotech
                  <br />• HTML5 with JavaScript & CSS3 (Microsoft)
                </p>
              </div>
            </div>
      ...
      <footer>
        <div className="footer-inner">
          ...
          >
            .NET Developer — Pune, IN | prafulnimje1999@gmail.com |
            +919021070022
          </p>
          ...
          <p style={{ fontSize: "0.82rem", color: "var(--accent)" }}>
            © {new Date().getFullYear()} Prafull Nimje — .NET Developer
            Portfolio
          </p>
        </div>
      </footer>
